...
public class VGStepDefinitions {
    ...
    public void a_user_clicks_on_the_newsletter_link(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @When("does not enter an email address")
    public void does_not_enter_an_email_address() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @When("clicks the sign-up button \\({string})")
    public void clicks_the_sign_up_button(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @When("does not tick the consent box")
    public void does_not_tick_the_consent_box() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @Then("the error message {string} should show")
    public void the_error_message_should_show(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @When("a user clicks on {string}")
    public void a_user_clicks_on(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void all_programs_should_be_listed_correctly_and_according_to_the_first_letter_in_the_program_name() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @When("a user searches for {string}")
    public void a_user_searches_for(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("the first listed program should be {string}")
    public void the_first_listed_program_should_be(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Then("the text \"Inget resultat för sökningen \"qwerty\"\" should be shown")
    public void the_text_inget_resultat_för_sökningen_qwerty_should_be_shown() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void clicks_the_fullscreen_button(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void a_user_clicks_on_a_program_in_the_section(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
